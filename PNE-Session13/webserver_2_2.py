...
WEBSERVER 2_2: Getting information from the request message

As our TestHandler is derived from the Base class BaseHTTPRequestHandler, it inheritates all its properties and methods.

In this example we will print the following properties:

- self.requestline: It contatins the full request line (remember that the request line is the first line of the HTTP
request messages).
