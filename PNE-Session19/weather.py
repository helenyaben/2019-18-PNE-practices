...
For example, the Madrid WOEID is 766273. Let's test it first in the browser, accessing to the following URL:
https://www.metaweather.com/api/location/766273/

This client will get the information about Madrid and print the time, the weather description and the temperature on
the console:
