...
if weather == []:
    print('The woeid is not known')
    sys.exit(0)


woeid = weather[0]["woeid"]

print('Woeid of the city of {} is: {}'.format(city, woeid))

# Now we have the woeid of the city introduced we will make another request

# Example of getting information about the weather of
# a location

print()
termcolor.cprint("REQUEST 2: WEATHER", 'yellow')
print()
